...
export default function ReportPage() {
  ...
  useEffect(() => {
    ...
    const host = import.meta.env.VITE_SHORT_HOST || import.meta.env.VITE_APP_HOST;
  ...
  return (
    <div className="flex flex-col gap-8 sm:gap-10 pb-20 mx-auto max-w-2xl w-full">
      ...
      <section className="space-y-3 px-1">
        <Link to="/" className="btn-secondary w-fit px-5 py-2 text-[10px] nothing-label opacity-100 hover:bg-(--db-text) hover:text-(--db-bg) transition-all">
