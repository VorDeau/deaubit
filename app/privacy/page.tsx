      ...
      <div className="db-card p-8 lg:p-12 space-y-10 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-(--db-text-muted) leading-relaxed font-medium mb-3">
            We collect information you provide directly to us, such as when you create an account or shorten a link:
          </p>
          <ul className="space-y-2 pl-4">
            {[
              "Account Information: Name, Email address.",
              "Usage Data: IP address, browser type, device type, and referral URLs (for link analytics).",
            ].map((item, i) => (
        ...
        <div className="bg-(--db-surface-hover) rounded-2xl p-6 border border-(--db-border)">
          <p className="nothing-label text-[9px] opacity-60 normal-case tracking-normal leading-relaxed">
